...
esc_html_e( 'Name', 'packs-shipment' ); echo $shipment['deliveryAddress']['name'] . "\n";
esc_html_e( 'Street', 'packs-shipment' ); echo $shipment['deliveryAddress']['street']. "\n";
esc_html_e( 'Number', 'packs-shipment' ); echo $shipment['deliveryAddress']['number']. "\n";
esc_html_e( 'Zipcode', 'packs-shipment' ); echo $shipment['deliveryAddress']['zip']. "\n";
esc_html_e( 'City/Town', 'packs-shipment' ); echo $shipment['deliveryAddress']['place']. "\n";
